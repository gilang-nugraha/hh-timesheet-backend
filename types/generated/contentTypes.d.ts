...
export interface ApiWorkWork extends Schema.CollectionType {
  ...
  attributes: {
    ...
    setting: Attribute.JSON;
    baseDuration: Attribute.Integer;
    overtimeDuration: Attribute.Integer;
    baseIncome: Attribute.Float;
    overtimeIncome: Attribute.Float;
    totalDuration: Attribute.Integer;
    totalIncome: Attribute.Float;
    employeeRate: Attribute.Float;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiWorkTimeWorkTime extends Schema.SingleType {
  ...
  attributes: {
    ...
    overtimeRate: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
